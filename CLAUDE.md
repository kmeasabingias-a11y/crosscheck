...
This file has two parts. **Part 1 is the Working Agreement** — the rules for how you (Claude Code) operate on this project. **Part 2 is the full Project Specification (v2)** — what to build. Read both, in order, before doing anything. If Part 1 and Part 2 ever conflict, Part 1 wins.
...
# PART 2 — PROJECT SPECIFICATION (v2)
...
— End of CLAUDE.md. Part 1 (Working Agreement) governs how you operate; Part 2 (this spec) defines what to build. Begin with Phase 0 — in hand-over mode. —
